          ...
          this.yPost(this.yzxhttp+'appApi/appUser/login',{
            ...
            (response)=>{
              if(response.data.resultCode== 0){
                ...
                if(bindDevFlag==="Y"){
                  this.$router.push('/flowMall?bindDevFlag='+bindDevFlag+"&loginName="+loginName+'&phoneNo='+phoneNo+'&flowMall=Y');
                }else{
                  this.$router.push('/successLogin?bindDevFlag='+bindDevFlag+"&loginName="+loginName+'&phoneNo='+phoneNo+'&flowMall=Y');
                }
              }else{
                //错误提示
